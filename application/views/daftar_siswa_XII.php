            ...
            <div class="box-header">
              ...
              <div class="col-xs-10">
                ...
                <ul class="nav navbar-right panel_toolbox">
                  <li><a href="<?php echo base_url();?>index.php/siswa/kelas_12/"><i class="glyphicon glyphicon-refresh"></i></a></li>
                </ul>
              </div>
              <div class="col-xs-2">
          ...
          <form class="form-horizontal" method="post" id="form-pendaftaran" enctype="multipart/form-data" action="simpan_siswa"> 
              <div class="box-body">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" id="nis"" name="nis" required="required" placeholder="NIS" class="form-control" value="">
                  </div>
                </div>
                <div class="form-group">
                   <label class="control-label col-sm-2" for="nama_siswa">Nama Siswa <span class="required">*</span></label>
                    ...
                    <div class="col-sm-10">
                      <input type="text" id="nama_siswa" name="nama_siswa" required="required" placeholder="Nama Siswa" class="form-control" value="">
                    </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" id="tempat_lahir" name="tempat_lahir" required="required" placeholder="Tempat Lahir" class="form-control" value="">
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" id="tanggal_lahir" name="tanggal_lahir" required="required" placeholder="0000-01-01" class="form-control" value="">
                  </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <textarea id="alamat" name="alamat" required="required" class="form-control" rows="5" placeholder="Jl. Danau Ranau G6B/2 Sawojajar, Malang, Jawa Timur, Indonesia" value=""></textarea>
                  </div>
                </div>
                <div class="form-group">
                 <label class="control-label col-sm-2">No. Telp <span class="required">*</span></label>
                  ...
                  <div class="col-sm-10">
                    <input type="text" id="nomor_telp" name="no_telp" required="required" placeholder="0852xxxxxxxx" class="form-control" value="">
                  </div>
                </div>
                <div class="form-group">
    ...
    <div class="modal fade" id="'.$data->nis.'" role="dialog">
    <div class="modal-dialog modal-lg">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form class="form-horizontal" method="post" id="form-pendaftaran" enctype="multipart/form-data" action="edit_siswa"> 
              <div class="box-body">
                <div class="form-group">
                  <label class="control-label col-sm-2" for="nis">NIS <span class="required">*</span>
                  </label>
                  ...
                  <div class="col-sm-10">
                    <input type="text" id="nis"" name="nis" required="required" placeholder="NIS" class="form-control" value="'.$data->nis.'" readonly>
                  </div>
                </div>
                <div class="form-group">
                   <label class="control-label col-sm-2" for="nama_siswa">Nama Siswa <span class="required">*</span></label>
                    ...
                    <div class="col-sm-10">
                      <input type="text" id="nama_siswa" name="nama_siswa" required="required" placeholder="Nama Siswa" class="form-control" value="'.$data->nama_siswa.'">
                    </div>
                </div>
                <div class="form-group">
                  <label class="control-label col-sm-2" for="tempat_lahir">Tempat Lahir <span class="required">*</span></label>
                  ...
                  <div class="col-sm-10">
                    <input type="text" id="tempat_lahir" name="tempat_lahir" required="required" placeholder="Tempat Lahir" class="form-control" value="'.$data->tempat_lahir.'">
                  </div>
                </div>
                <div class="form-group">
                  <label class="control-label col-sm-2" for="tanggal_lahir">Tanggal Lahir <span class="required">*</span></label>
                  ...
                  <div class="col-sm-10">
                    <input type="text" id="tanggal_lahir" name="tanggal_lahir" required="required" placeholder="0000-01-01" class="form-control" value="'.$data->tanggal_lahir.'">
                  </div>
                </div>
                <div class="form-group">
                  <label class="control-label col-sm-2">Jenis Kelamin <span class="required">*</span></label>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <textarea id="alamat" name="alamat" required="required" class="form-control" rows="5" placeholder="Alamat">'.$data->alamat.'</textarea>
                  </div>
                </div>
                <div class="form-group">
                 <label class="control-label col-sm-2">No. Telp <span class="required">*</span></label>
                  ...
                  <div class="col-sm-10">
                    <input type="text" id="nomor_telp" name="no_telp" required="required" placeholder="0852xxxxxxxx" class="form-control" value="'.$data->no_telp.'">
                  </div>
                </div>
                <div class="form-group">
                  <label class="control-label col-sm-2">Tingkat <span class="required">*</span></label>
                ...
                <div class="form-group">
                  <label for="kelas" class="col-sm-2 control-label">Kelas <span class="required">*</span></label>
