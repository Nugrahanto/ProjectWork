                ...
                <div class="x_panel">
                  <div class="x_title">
                    ...
                    <ul class="nav navbar-right panel_toolbox">
                      ...
                      <li><a href="<?php echo base_url();?>index.php/karyawan/tambah_karyawan"><i class="fa fa-refresh"></i></a>
                      </li>
                    </ul>
                    <div class="clearfix"></div>
                  </div>
                  <div class="x_content">
                    <br />
                    <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="post" enctype="multipart/form-data" action="<?php echo base_url();?>index.php/karyawan/simpan_karyawan">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="kode_karyawan" name="kode_karyawan" required="required" placeholder="A25" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="nip" name="nip" required="required" placeholder="0004334478" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="nama_karyawan" name="nama_karyawan" required="required" placeholder="Rianirsyah Dian Nugrahanto" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <textarea id="alamat" name="alamat_karyawan" required="required" class="form-control" rows="5" placeholder='Jl. Danau Ranau G6B/2 Sawojajar, Malang, Jawa Timur, Indonesia'></textarea>
                        </div>
                      </div>
                      <div class="form-group">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="mapel1" name="mapel1" placeholder="Matematika" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="mapel2">Mata Pelajaran 2 </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="mapel2" name="mapel2" placeholder="Sejarah Indonesia" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
